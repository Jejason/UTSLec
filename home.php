...
<head>
    ...
    <title>Leblanc - Restaurant</title>
...
<body class="stop-scroll">
    ...
    <header id="header">
        <nav>
            <div class="logo">
                <a href="home.php"><img src="img/logo1.png" class="leblanc" alt="Leblanc Logo"></a>
            </div>
            <div class="toggle">
            ...
            <div class="navigation-bar">
                <ul>
                    <li class="active"><a href="#header">Home<span class="underline"></span></a></li>
                    <li><a href="#menu" data-toggle="tab">Menu<span class="underline"></span></a></li>
        ...
        <div class="text">
            <h2 class="sub-headline">Welcome</h2>
            <h1 class="headline">Leblanc</h1>
            <div class="arrow">
                <span class="left"></span>
                <i class="fas fa-asterisk"></i>
                <span class="right"></span>
            </div>
            <span class="single-animation">Ready To Be Opened</span>
        </div>
    ...
    <div class="about-us" id="about">
        <div class="text">
            ...
            <p>Leblanc is a restaurant, bar and coffee roastery located on a busy corner site in Farringdon’s Exmouth Market. With glazed frontage on two sides of the building, overlooking the market.</p>
            <div><a class="a-CTA" href="aboutUs.php">About Us</a></div>
        </div>
    ...
    <footer>
        <div class="text">
            <h2>ABOUT Leblanc</h2>
            <div><i class="fas fa-asterisk"></i></div>
            <p>Leblanc adalah destinasi kuliner eksklusif yang memadukan seni, citarasa, dan kenyamanan dalam satu pengalaman yang tak terlupakan. Dengan dekorasi interior yang menawan, nuansa modern dan berkelas, serta pencahayaan yang lembut, restoran ini cocok untuk berbagai acara, mulai dari perayaan khusus hingga pertemuan bisnis.</p>
        </div>
    ...
    <div class="copyright">
        <svg class="svg-up" width="192" height="61" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 160.7 61.5" enable-background="new 0 0 160.7 61.5" xml:space="preserve">
        ...
        <ul class="info">
            <li>&copy; LEBLANC 2023</li>
            <li>13 Hanway Square, Indonesia</li>
            <li>Tel: 12345678</li>
            <li>Handcrafted with love by <a href="#">Leblanc</a> Team</li>
        </ul>
        <ul class="CTA">
